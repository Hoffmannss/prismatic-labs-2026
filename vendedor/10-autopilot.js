...
// ── Paths (data fica dentro de vendedor/) ────────────────────
...
// ── CRM: usernames ja cadastrados (evita duplicatas) ─────────
...
// ── Apify: aguardar run finalizar (polling 5s) ────────────────
...
// ── Apify: buscar itens do dataset do run ─────────────────────
...
// ── ETAPA 1: Scrape posts por hashtags ───────────────────────
...
// ── ETAPA 2: Enriquecer perfis (bio/followers/posts) ─────────
...
// ── ETAPA 3: Analyze via orchestrator (spawn) ─────────────────
...
// ── Montar descricao de posts para o analyzer ─────────────────
...
async function main() {
  ...
  console.log(`  Usernames novos (nao estao no CRM): ${uniq.size}`);
